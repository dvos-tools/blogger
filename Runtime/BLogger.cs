...
namespace com.DvosTools.blogger 
{
    ...
    public static class BLogger
    {
        ...
        /// <param name="context">Optional context object (for Unity Console filtering)</param>
        /// <param name="includeStackTrace">Whether to automatically capture stack trace (default: false for performance)</param>
        public static void Log(object message, Object? context = null, bool includeStackTrace = false)
        {
        ...
        /// <param name="context">Optional context object (for Unity Console filtering)</param>
        /// <param name="includeStackTrace">Whether to automatically capture stack trace (default: false for performance)</param>
        public static void Warn(object message, Object? context = null, bool includeStackTrace = false)
        {
            var stackTrace = includeStackTrace ? System.Environment.StackTrace : "";
        ...
        /// <param name="context">Optional context object (for Unity Console filtering)</param>
        /// <param name="includeStackTrace">Whether to automatically capture stack trace (default: false for performance)</param>
        public static void Error(object message, Object? context = null, bool includeStackTrace = false)
        {
            var stackTrace = includeStackTrace ? System.Environment.StackTrace : "";
